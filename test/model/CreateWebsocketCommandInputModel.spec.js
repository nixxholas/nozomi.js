...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NozomiApi.CreateWebsocketCommandInputModel();
  });
  ...
  describe('CreateWebsocketCommandInputModel', function() {
    it('should create an instance of CreateWebsocketCommandInputModel', function() {
      // uncomment below and update the code to test CreateWebsocketCommandInputModel
      //var instane = new NozomiApi.CreateWebsocketCommandInputModel();
      //expect(instance).to.be.a(NozomiApi.CreateWebsocketCommandInputModel);
    });
