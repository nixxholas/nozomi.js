...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NozomiApi.CreateRequestInputModel();
  });
  ...
  describe('CreateRequestInputModel', function() {
    it('should create an instance of CreateRequestInputModel', function() {
      // uncomment below and update the code to test CreateRequestInputModel
      //var instane = new NozomiApi.CreateRequestInputModel();
      //expect(instance).to.be.a(NozomiApi.CreateRequestInputModel);
    });
    ...
    it('should have the property socketDataCount (base name: "socketDataCount")', function() {
      // uncomment below and update the code to test the property socketDataCount
      //var instane = new NozomiApi.CreateRequestInputModel();
      //expect(instance).to.be();
    });

    it('should have the property socketKillSwitchDelay (base name: "socketKillSwitchDelay")', function() {
      // uncomment below and update the code to test the property socketKillSwitchDelay
      //var instane = new NozomiApi.CreateRequestInputModel();
      //expect(instance).to.be();
    });
