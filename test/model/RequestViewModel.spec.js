...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NozomiApi.RequestViewModel();
  });
  ...
  describe('RequestViewModel', function() {
    it('should create an instance of RequestViewModel', function() {
      // uncomment below and update the code to test RequestViewModel
      //var instane = new NozomiApi.RequestViewModel();
      //expect(instance).to.be.a(NozomiApi.RequestViewModel);
    });
