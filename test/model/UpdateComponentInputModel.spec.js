...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NozomiApi.UpdateComponentInputModel();
  });
  ...
  describe('UpdateComponentInputModel', function() {
    it('should create an instance of UpdateComponentInputModel', function() {
      // uncomment below and update the code to test UpdateComponentInputModel
      //var instane = new NozomiApi.UpdateComponentInputModel();
      //expect(instance).to.be.a(NozomiApi.UpdateComponentInputModel);
    });
