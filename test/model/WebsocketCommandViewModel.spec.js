...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NozomiApi.WebsocketCommandViewModel();
  });
  ...
  describe('WebsocketCommandViewModel', function() {
    it('should create an instance of WebsocketCommandViewModel', function() {
      // uncomment below and update the code to test WebsocketCommandViewModel
      //var instane = new NozomiApi.WebsocketCommandViewModel();
      //expect(instance).to.be.a(NozomiApi.WebsocketCommandViewModel);
    });
