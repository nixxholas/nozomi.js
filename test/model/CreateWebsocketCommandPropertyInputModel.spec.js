...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NozomiApi.CreateWebsocketCommandPropertyInputModel();
  });
  ...
  describe('CreateWebsocketCommandPropertyInputModel', function() {
    it('should create an instance of CreateWebsocketCommandPropertyInputModel', function() {
      // uncomment below and update the code to test CreateWebsocketCommandPropertyInputModel
      //var instane = new NozomiApi.CreateWebsocketCommandPropertyInputModel();
      //expect(instance).to.be.a(NozomiApi.CreateWebsocketCommandPropertyInputModel);
    });
