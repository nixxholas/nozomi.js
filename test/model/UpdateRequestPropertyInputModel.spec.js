...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NozomiApi.UpdateRequestPropertyInputModel();
  });
  ...
  describe('UpdateRequestPropertyInputModel', function() {
    it('should create an instance of UpdateRequestPropertyInputModel', function() {
      // uncomment below and update the code to test UpdateRequestPropertyInputModel
      //var instane = new NozomiApi.UpdateRequestPropertyInputModel();
      //expect(instance).to.be.a(NozomiApi.UpdateRequestPropertyInputModel);
    });
