...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NozomiApi.ComponentTypeViewModel();
  });
  ...
  describe('ComponentTypeViewModel', function() {
    it('should create an instance of ComponentTypeViewModel', function() {
      // uncomment below and update the code to test ComponentTypeViewModel
      //var instane = new NozomiApi.ComponentTypeViewModel();
      //expect(instance).to.be.a(NozomiApi.ComponentTypeViewModel);
    });
